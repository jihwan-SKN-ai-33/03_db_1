...
values(null,
       ...
       4,
       'Y');
# 'menu_name' cannot be null

# 문법 2. 작성한 컬럼 값 제공
# menu_code 제외 -> 자동으로 null -> auto increment 적용 -> 자동으로 숫자 제공
insert into
    tbl_menu(menu_price,
             orderable_status,
             menu_name,
...
# - 새로운 데이터를 테이블에 삽입할 때
#   pk(식별자) 컬럼 값이 중복되는 값이 없으면 insert
...
values (100,
        ...
        8,
        'Y'); # update 모습
                            # (실제) delete 후 insert 수행 -> 2개 행이 영향을 받았습니다
select *
from tbl_menu;